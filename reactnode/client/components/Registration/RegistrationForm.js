...
import validateInput from '../../validations/registrationValidations';
...
class RegistrationForm extends Component {
    ...
    render() {
        const {errors , first_name, last_name, email, mobile_no, password, isLoading} = this.state;
        return (
            <form className="p20 user-entry-forms login-form" onSubmit={this.onSubmit}>
                <h2 className="mt0 mb20 text-center">Registration Form</h2>
